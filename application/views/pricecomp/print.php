...
<div>
    <span style="font-size: 18px;font-weight: bold;">Price Comparison List</span><br/>
    <span style="font-size: 16px;font-weight: bold;">PR No : <?php echo $pr->requestnumber?></span>
</div>
<br/>
<table border='0' width='890' style="font-size: 8pt;">
    <thead>
        <tr>
