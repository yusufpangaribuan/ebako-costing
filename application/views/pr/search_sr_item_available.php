<form id='pr_sr_item_input_88' onsubmit="return false;">
        ...
        <tbody>
            ...
            foreach ($item as $result) {
                ...
                <tr id='row-<?php echo $result->id ?>'>
                    <td align="center"><input type="checkbox" name="sritem_checked_ii[]" value="<?php echo $result->id ?>"/></td>
                    <td id='itempartnumber'>
                        <?php echo $result->target_item_code ?>
                    </td>
                    <td id='itemdescription'><?php echo $result->target_item_description ?></td>
                    <td align="center">
                        <input type="hidden" id='itemid_i<?php echo $result->id ?>' value="<?php echo $result->target_itemid ?>"/>
                        <?php echo $result->qty ?>
                    </td>
                    <td align="center">
                    ...
                    <td align="center"><?php echo $result->sr_no ?></td>
