<div style="width: 400px">        
    ...
    <table width="100%" border="0" class="tablesorter">
            ...
            echo "<tr/>";
            echo "<tr>";
            echo "<td>From </td><td> :" . $result->warehousename . "</td>";
            echo "<tr/>";
            echo "<tr>";
        ...
        </table><button style="font-size: 11px;" onclick="item_approvetransfer(<?php echo $result->id . "," . $result->itemid ?>)">Approve</button><br/>
        <?php
    }
    ?>
</table>
