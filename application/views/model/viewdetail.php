    ...
    <tr valign="top">
        <td width="50%">
            <div style="margin-bottom: 6px">
                ...
                if ($this->session->userdata('department') == 4) {
                    if (in_array('add_material', $accessmenu)) {
                        echo "<button class='btn btn-success' onclick = 'model_addhardware($id)' style = 'float: right;'>Add</button>";
                    }
                }
                ?>
            </div>
            ...
            <div style="margin-top: 5px;margin-bottom: 6px">
                ...
                if ($this->session->userdata('department') == 4) {
                    if (in_array('add_material', $accessmenu)) {
                        echo "<button class='btn btn-success' onclick = 'model_setglass($id)' style = 'float: right'>Add</button>";
                    }
                }
                ?>
            </div>
            ...
            <div style="margin-top: 5px;margin-bottom: 6px">
                ...
                if ($this->session->userdata('department') == 4) {
                    if (in_array('add_material', $accessmenu)) {
                        echo "<button class='btn btn-success' onclick='model_setmarble($id)' style='float: right'>Add</button>";
                    }
                }
                ?>
            </div>
            ...
            <div style="margin-top: 5px;margin-bottom: 6px">
                ...
                if ($this->session->userdata('department') == 4) {
                    if (in_array('add_material', $accessmenu)) {
                        echo "<button class='btn btn-success' onclick = 'model_setlatherinlay($id)' style = 'float: right'>Add</button>";
                    }
                }
                ?>
            </div>
            ...
            <div style="margin-top: 5px;margin-bottom: 6px">
                ...
                if ($this->session->userdata('department') == 4) {
                    if (in_array('add_material', $accessmenu)) {
                        echo "<button class='btn btn-success' style = 'float: right' onclick = 'model_setpacking($id)'>Add</button>";
                    }
                }
                ?>
            </div>
