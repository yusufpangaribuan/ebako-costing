<div style="width: 900px;height: 500px;padding: 5px 15px 5px 5px;">
                        ...
                        <table width="100%" border="0">
                            <tr valign="top">
                                        ...
                                        <tr>
                                            ...
                                            <td width="75%">
                                                <script type="text/javascript" >
                                                    $(function () {
                                                        $("#gr_rpt_date_start").datepicker({
                                                            dateFormat: "yy-mm-dd",
                                                            changeMonth: true,
                                                            changeYear: true,
                                                            showButtonPanel: true
                                                        }).focus(function () {
                                                            $("#gr_rpt_date_start").datepicker("show");
                                                        });
                                                        $("#gr_rpt_date_end").datepicker({
                                                            dateFormat: "yy-mm-dd",
                                                            changeMonth: true,
                                                            changeYear: true,
                                                            showButtonPanel: true
                                                        }).focus(function () {
                                                            $("#gr_rpt_date_end").datepicker("show");
                                                        });
                                                    });
                                                </script>
                                                <input type="text" id="gr_rpt_date_start" name="date_start" size="9"/>
                                                <strong>To :</strong>
                                                <input type="text" id="gr_rpt_date_end" name="date_end" size="9" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right"><label class="labelelement" >GR No. :</label></td>
                                            <td><input type="text" name="gr_no" size="9" style="width: 70%"/></td>
                                        </tr>
                                        <tr>
                                ...
                                <td width="60%">
                                    <table width="100%" border="0">                                        
                                        <tr>
                                            <td align="right" width="25%" ><label class="labelelement">Department :</label></td>
                                            <td width="75%" >
                                                <select id="gr_rpt_departmentid" name="departmentid">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="gr_rpt_sub_departmentid" name="sub_departmentid">
                                                    <option value="0">--All--</option>
                                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="cost_center_id" name="cost_center_id" onchange="cost_center_load_member(this, 'gr_member_cost_center_id')" style="width: 150px">
                                                ...
                                                <select id="gr_member_cost_center_id" name="member_cost_center_id" style="width: 120px">
                            ...
                            <tr>
                                <td align="center" colspan="2"><br/>
                                    <button type="button" onclick="gr_rpt_gennerate(1)">View</button>
                                    <button type="button" onclick="gr_rpt_gennerate(2)">Print</button>
                                    <button type="button" onclick="gr_rpt_gennerate(3)">Export to Excel</button>
                                    <br/><br/>
                                </td>
                            </tr>
                        </table>
    ...
    <div class="panel" style="overflow: auto;">
        ...
        <div id="gr_rpt_temp_preview" style="width: 100%;height: 400px;overflow-y: auto;overflow-x: scroll;">
