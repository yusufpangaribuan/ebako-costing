<div   style='width: 1000px;
    ...
    <table width="100%" class="tablesorter">
        <tr>
            ...
            <td width="30%">
                <a href="javascript:void(0)" onclick="model_add_other_material_overview(<?php echo $modelid . ",1" ?>)">Others</a>
                <?php
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="model_add_other_material_overview(<?php echo $modelid . ",2" ?>)">Others</a>
                <?php
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="model_add_other_material_overview(<?php echo $modelid . ",3" ?>)">Others</a>
                <?php
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="model_add_other_material_overview(<?php echo $modelid . ",4" ?>)">Others</a>
                <?php
        ...
        <tr>
            ...
            <td>
                <a href="javascript:void(0)" onclick="model_add_other_material_overview(<?php echo $modelid . ",5" ?>)">Others</a>
                <?php
    ...
    <div style="margin-top: 6px">
        <center>
            <button onclick="model_save_material_overview(<?php echo $modelid ?>)">Save</button>
            <button onclick="model_material_overview(<?php echo $modelid ?>)">Reset</button>
