    ...
    if ($st == 1) {
        ...
        <div style="width: 100%;border: 0px solid #000000;min-height: 300px;">
            ...
            <table width="99%" style="border: none">
                ...
                <tr>
                    <td style="border: none;text-align: center;"><span style="font-size: 18px;"><b>MATERIAL RETURN SLIP</b></span></td>
                </tr>
            </table>
            <br/>
                ...
                <tr valign="top">
                    <td width="50%" style="border: none;">
                        <table width="100%" style="border:none;">
                            <tr>
                                <td style="border: none;" width='30%'><strong>NO</strong></td>
                                <td style="border: none;" width='1%'><strong>:</strong></td>
                                <td style="border: none;" width='69%'><?php echo $returnproduction->returnproduction_no ?></td>
                            </tr>
                            <tr>
                                <td style="border: none;"><strong>Date</strong></td>
                                <td style="border: none;"><strong>:</strong></td>
                                <td style="border: none;"><?php echo (empty($returnproduction->date)) ? "" : date('d/m/Y', strtotime($returnproduction->date)) ?></td>
                            </tr>
                            <tr>
                                <td style="border: none;"><strong>Department</strong></td>
                                <td style="border: none;"><strong>:</strong></td>
                                <td style="border: none;"><?php echo $returnproduction->department_name ?></td>
                            </tr>
                        </table>
                    </td>
                    <td width="50%" style="border: none;">
...
<!--                        <table width="100%" style="border:none;">
                            <tr>
                                ...
                                <td style="border: none;" width='1%'><strong>:</strong></td>
                                <td style="border: none;" width='59%'><?php echo $returnproduction->customer_name ?></td>
                            </tr>
                            <tr>
                                <td style="border: none;font-weight: bold;"><strong>AWB </strong></td>
                                <td style="border: none;"><strong>:</strong></td>
                                <td style="border: none;"><?php echo $returnproduction->awb ?></td>
                            </tr>
                            <tr>
                                <td style="border: none;font-weight: bold;"><strong>VIA </strong></td>
                                <td style="border: none;"><strong>:</strong></td>
                                <td style="border: none;"><?php echo $returnproduction->via ?></td>
                            </tr>
                        </table>                    -->
                    </td>            
                </tr>
            ...
            <table border='0' width='99%' cellpadding='0' cellspacing='0'>
                ...
                <?php
                $count_row = 10;
                if (!empty($returnproductionitem)) {
                    $counter = 1;

                    foreach ($returnproductionitem as $result) {
                        ?>
                        <tr valign="top">
                            ...
                            <td style='border-width:0px 1px 0px 0px;border-color: #000000;border-style: solid;padding: 2px;'><?php echo $result->type_desc."<br/>".$result->remark; ?></td>
                        </tr>
                        <?php
                        $count_row--;
                    }
            ...
            <table width="100%" border="0">
                <tr>
                    <td width="30%" align="center" style="border-bottom: 1px #000000 solid;">
                        ...
                        <br/>
                        <br/>
                        <?php echo $returnproduction->name_returned_by ?>
                    </td>
                    <td>&nbsp;</td>
                    ...
                    <td width="30%" align="center" style="border-bottom: 1px #000000 solid;">
                        ...
                        <br/>
                        <br/>
                        <?php echo $returnproduction->name_received_by ?>
                    </td>
                </tr>
            </table><br/>
        ...
        if ($st == 1) {
            ...
            ?><br/>
            <a href="<?php echo base_url('index.php/returnproduction/prints/' . $returnproduction->id . '/1') ?>" target="blank"><button>print</button></a>
            <?php
        }
        ?>
</body>
