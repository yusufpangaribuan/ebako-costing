    ...
    <div style="width: 80%;" class="panel">           
        ...
        if ($so->finishbyrnd == 't') {
            if ($this->session->userdata('department') == 2) {
                if ($so->iscreatemrp == 'f') {
                    echo "<button onclick='so_createmrp(" . $soid . ")'  style='width:80px'>Create MRP</button>";
                } else {
                    echo "<button onclick='so_viewmrp(" . $soid . ")' style='width:80px'>View MRP</button>";
                }
            }
        }
        ?>                
...
<!--                                    <td align="center">-->
                                        <?php
                                        if ($so->iscreatemrp == 't') {
//                                            echo "<button style='width:100%'>Create W/O</button>";
                                        }
                                        ?>
<!--                                    </td>                                -->
                                </tr>
