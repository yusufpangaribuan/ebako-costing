...
$this->excel->getActiveSheet()->setCellValue('A2', "P.O Critical Outstanding Receive");
...
$col++;
$this->excel->getActiveSheet()->setCellValue($coloum[$col] . "" . $row, 'Vendor/Supplier');
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setSize(8);
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setBold(true);
...
$col++;
$this->excel->getActiveSheet()->setCellValue($coloum[$col] . "" . $row, 'Delivery Term');
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setSize(8);
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setBold(true);
$this->excel->getActiveSheet()->getColumnDimension($coloum[$col])->setWidth(12);
...
foreach ($po_critical as $result) {
    ...
    $col++;
    $this->excel->getActiveSheet()->setCellValue($coloum[$col] . "" . $row, $result->po_date);
    $this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setSize(8);
    $this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    ...
    $col++;
    $this->excel->getActiveSheet()->setCellValue($coloum[$col] . "" . $row, ($result->delivery_date_valid == 't') ? date('d/m/Y', strtotime($result->deliveryterm)) : $result->deliveryterm);
    $this->excel->getActiveSheet()->getStyle($coloum[$col] . "" . $row)->getFont()->setSize(8);
