		...
		<div>
		<table id="table_costing_pricelist" class="stripe row-border" border="1" style="width:100%">
			<?php 
		    ...
		    <thead>
		        <tr>
		            ...
		            <th colspan="<?php echo $ranges_length?>" style="text-align: center;">
		            	...
		            	<b><?php echo @$price_list_base_on == "rate"? "Rate" : "FOB" ;?></b>
		            </th>
		        </tr>
		        <tr>
		        	<?php 
				...
				<?php
			        ...
			        foreach ($costing as $result) {
			            ...
			            <tr valign="top">
			                ...
			                <?php 
				        		foreach ($ranges as $range){
				        			echo "<td>" . $costing_details[ $result->id ]['margin'][ $range ] . "</td>";
				        		}
				        	?>
			                <?php 
				        		foreach ($ranges as $range){
				        			echo "<td>" . number_format($costing_details[ $result->id ]['fob'][ $range ], 2) . "</td>";
				        		}
				        	?>
			            </tr>
			            <?php
