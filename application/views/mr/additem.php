<tr valign="top">
                ...
                $("#partnumber<?php echo $flag ?>").autocomplete({
                    ...
                    select: function (event, ui) {
                        ...
                        $.get(url + 'item/getwarehouse/' + ui.item.id, function (content) {
                            $('#warehouseid<?php echo $flag ?>').empty();
                            $('#warehouseid<?php echo $flag ?>').append(content);
                        });
                        $('#stock<?php echo $flag ?>').load(url + 'item/gettotalstock/' + ui.item.id);
                    }
    ...
    <td>
        ...
        Stock : <span id="stock<?php echo $flag ?>">0</span>
    </td>
    <td>
        <select name="warehouseid" id="warehouseid<?php echo $flag ?>" style="width: 100%">
