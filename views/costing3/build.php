					            ...
					            if ($flag == 2) {
					                ...
					                if ($costing->locked == 'f') {
					                    if ($costing->isreviewed == 'f') {
					                        echo "<button class='btn btn-md btn-primary pull-left' onclick='costing_savefobprice(" . $id . ")' style='font-size: 11px;'>Save</button>";
					                    } else {
					                        echo "<button class='btn btn-md btn-primary pull-left' onclick='costing_savefobprice(" . $id . ")' style='font-size: 11px;display:none;' id='costingsave'>Save</button>";
