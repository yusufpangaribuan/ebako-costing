...
<script src="<?php echo $base_url ?>assets/vendors/vuejs/vue.js"></script>
    ...
    <center>
        <table width="900"  celpadding="0" cellspacing="0" style="border-collapse: collapse;border:1px solid black;font-size: 9px;font-family:Verdana,Georgia,Serif;">
            <thead>
                <tr>
                    <th align="left" style="border:1px solid black;">Customer {{message}}</th>
                    ...
                    foreach ($costingdetail as $result) {
                        ...
                        <tr>
                            ...
                            <td align="right" style="border:1px solid black;background-color:#bbffb0;">
                            	<a data-id="<?php echo $result->id;?>" style="display: none;" href="#" class="qty-uom" class="editable editable-click" 
                            		data-type="text" 
                            	...
                            	<input v-model="message" value="<?php echo ($result->qty == 0) ? "" : $result->qty; ?>">
                            	{{message}} <br/>
