<div style="width: 400px;">
    <form id="returnproduction_edit_form" onsubmit="return false;">
        <table align="center" width="100%" border="0">
            <tr>
                <td width="20%"><strong>Date</strong></td>
                <td widh="1%"><strong>:</strong></td>
                <td width="79%">
                    <input type="text" name="date" required="true" value="<?php echo $returnproduction->date ?>" size="12"/>
                    <script type="text/javascript" >
                        $(function () {
                            $("#returnproduction_edit_form input[name='date']").datepicker({
                                dateFormat: "yy-mm-dd"
                            }).focus(function () {
                                $("#returnproduction_edit_form input[name='date']").datepicker("show");
                            });
                        });</script>
                </td>
            </tr>     
            <tr valign="top">
                ...
                <td>
                    ...
                    <input id="partnumber0" class="ui-autocomplete-input" value="<?php echo $returnproduction->item_code ?>" type="text" style="width: 80%" name="item_code" autocomplete="off">
            ...
            <tr>
                ...
                <td><strong>:</strong></td>
                <td><input type="text" name="qty" required="true" style="width: 75px"value="<?php echo $returnproduction->qty ?>"/></td>
            </tr> 
            <tr>
                <td><strong>Remark</strong></td>
                <td><strong>:</strong></td>
                <td><textarea name="remark" style="width: 100%;height: 40px"><?php echo $returnproduction->remark ?></textarea></td>
            </tr>   
        </table>
    </form>
</div>
...
// just for the demos, avoids form submit
    ...
    $("#returnproduction_edit_form").validate({
