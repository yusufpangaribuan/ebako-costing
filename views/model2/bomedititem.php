    ...
    <table border="0" width="100%">            
        <tr>
            ...
            <td width="75%">
                ...
                <input type='text' name='partnumber' id='partnumber' value="<?php echo $component->partnumber ?>" style="width: 100%"/>
            </td>
        </tr>
        <tr valign="top">
            ...
            <td>
                ...
                <textarea id="description_input_model" name="description" style="height: 30px;width: 100%;"><?php echo $component->description ?></textarea>
            </td>  
        </tr>
        <tr>
            <td align="right"><span class="labelelement">Material&nbsp;&nbsp;:</span></td>
            <td>
                <input type="hidden" id="itemid-45" name="itemid" value="<?php echo $component->itemid ?>"/>
                <input type="text" id="description-45" name="description" style="width: 90%" value="<?php echo $component->item_description ?>"/>                    
        ...
        <tr>
            ...
            <td>
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <input type="hidden" id="itemid1" name="ven_id" value="<?php echo $component->ven_itemid ?>"/>
                            <input type="text" style="width: 70px;text-align: center;" name="ven_description" id="description1" value="<?php echo $component->ven_type ?>"/>
                            <img src="images/list.png" class="miniaction" onclick="item_listSearch(1)"/>
                            &nbsp;
                        </td>
                        <td><input type="text" style="width: 50px;text-align: center;" id="ven_s1s" name="ven_s1s" value="<?php echo $component->ven_s1s ?>"/>&nbsp;</td>
                        <td><input type="text" style="width: 50px;text-align: center;" id="ven_dgb" name="ven_dgb" value="<?php echo $component->ven_dgb ?>"/>&nbsp;</td>
                        <td><input type="text" style="width: 50px;text-align: center;" id="ven_s2s" name="ven_s2s" value="<?php echo $component->ven_s2s ?>"/>&nbsp;</td>
                        <td>&nbsp;&nbsp;
                            <?php
        ...
        <tr>
            ...
            <td><input type="text" style="width: 50px;text-align: center" id="qty" name="qty" value="<?php echo $component->qty ?>"/></td>
        </tr>
        <tr>
            <td align="right"><span class="labelelement">Location :</span></td>
            <td><input type="text" id="location" name="location" value="<?php echo $component->location ?>"/></td>
        </tr>
    </table>
<!--    <center>
        <button onclick="model_updatebomitem()">Update</button>
    </center>-->
</div>