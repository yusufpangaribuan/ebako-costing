<div style="width: 400px">
    <table width="100%" class="table_form">
        ...
        <tr>
            ...
            <td><input type="text" id="location" name="location" style="text-transform: uppercase;width: 90%"/></td>
        </tr>
        <tr>
            <td align="right"><span class="labelelement">Specifications</span></td>
            <td><input type="text" id="specifications" name="specifications" style="text-transform: uppercase;width: 90%"/></td>
        </tr>
<!--        <tr>
            <td>&nbsp;</td>
            <td>
                <button type="button" onclick="model_saveglass()">Save</button>
