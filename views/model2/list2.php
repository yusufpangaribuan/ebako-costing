                ...
                foreach ($model as $result) {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($billto == 0) {
                                ?>
                                <img src="images/check.png" onclick="model_set(<?php echo $result->id . ",'" . $temp . "'," . $id ?>)" class="miniaction"/>                                
                                <?php
                            } else {
                                ?>
                                <img src="images/check.png" onclick="model_set2(<?php echo $result->id . ",'" . $temp . "'," . $id ?>)" class="miniaction"/>
                                <?php
                            }
                            ?>                            
                        </td>
