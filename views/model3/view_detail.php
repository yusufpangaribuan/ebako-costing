...
<div id="model-tabs" class='fixed_header'>
    <ul class='ul_new'>
        <li><a href="#model_master_56y" onclick="model_last_tab = '#model_master_56y';">Detail</a></li>
        ...
        <li><a href="#glass_mirror" onclick="model_last_tab = '#glass_mirror';">Glass/Mirro</a></li>
    ...
    <div id="model_master_56y" style="min-height: 300px;overflow-y: auto">
        <table width='100%' class='fixed_header'>
            <tr valign='top'>
                <td width=100%>
                    <table class='fixed-header' width="600px">
    ...
    <div id="model_harware_56y" style="height: 350px;overflow-y: auto">
    ...
    <div id="glass_mirror" style="height: 350px;overflow-y: auto">
        <div style="margin-top: 5px;margin-bottom: 6px">            
            <?php
            if ($this->session->userdata('department') == 4) {
                if (in_array('add_material', $accessmenu)) {
    ...
    <div id="model_marble_u6y" style="height: 350px;overflow-y: auto">
        <div style="margin-top: 5px;margin-bottom: 6px">
            <?php
            if ($this->session->userdata('department') == 4) {
                if (in_array('add_material', $accessmenu)) {
    ...
    <div id="model_frame_in_lay_56y" style="height: 350px;overflow-y: auto">
        <div style="margin-top: 5px;margin-bottom: 6px">
            <?php
            if ($this->session->userdata('department') == 4) {
                if (in_array('add_material', $accessmenu)) {
    ...
    <div id="model_packing_material_56y" style="height: 350px;overflow-y: auto">
        <div style="margin-top: 5px;margin-bottom: 6px">
            <?php
            if ($this->session->userdata('department') == 4) {
                if (in_array('add_material', $accessmenu)) {
