        ...
        <table width="100%">
            <tr>
                ...
                <td>
                    ...
                    <select id="customerid" style="width: 200px;">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" id="modelcode0" value="<?php echo $costing->code ?>"/>
            ...
            <tr>   
                ...
                <td>
                    <br/>
                    <button onclick="costing_update()" style="font-size: 11px">OK</button>
                    <button onclick="costing_edit(<?php echo $costing->id ?>)" style="font-size: 11px">Reset</button>
                    <button onclick="$('#dialog2').dialog('close')" style="font-size: 11px">Cancel</button>
                </td> 
            </tr>
    </center>
</table>
